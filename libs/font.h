// Fonte 8x8 para caracteres A-Z, a-z e 0-9
// Cada caractere é representado por uma matriz de 8x8 pixels
...
static uint8_t font[] = {
    ...
    // Caracteres especiais podem ser adicionados conforme necessário
};
